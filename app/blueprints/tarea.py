...
from ..schemas.schemas import TipoTareaIn, TareaOut, TipoTareaOut
from ..models.alch_model import TipoTarea, Tarea
from ..models.tarea_model import get_all_tareas, get_all_tipo_tareas, insert_tipo_tarea
from app.common.error_handling import ObjectNotFound, InvalidPayload, ValidationError
#from flask_jwt_extended import jwt_required
from apiflask import APIBlueprint


tarea_b = APIBlueprint('tarea_b', __name__)
