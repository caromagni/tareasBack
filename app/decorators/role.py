    ...
    def decorator(f):
        ...
        def wrapped(*args, **kwargs):
            #try:
                ...
                if  (can_pass==False) and (rol != 'Superadmin' and rol.lower() != 'superadmin'):
                ...
                elif (can_pass==False and (rol == 'superadmin' or rol=='Superadmin')) or (not can_pass and config.RUN_DB_SETUP=='1'):
