...
class TareaOut(Schema):
    ...
    estado = Integer()
    id_actuacion = String()
    actuacion = Nested(ActuacionOut, only=("id", "id_ext", "nombre"))
    titulo = String()
    cuerpo = String()
    id_expediente = String()
    expediente = Nested(ExpedienteOut, only=("id", "id_ext", "caratula", "nro_expte"))
    #caratula_expediente = String()
    id_tipo_tarea = String()
    id_subtipo_tarea = String()
    eliminable = Boolean()
...
class TareaGetIn(Schema):
    ...
    order_fecha_creacion = String(metadata={"description": "asc o desc"}, validate=[
        validate.OneOf(['asc', 'desc'], error="El campo debe ser asc o desc")], default='desc') 
...
class TareaxGrupoIdOut(Schema):
    ...
    subtipo_tarea = Nested(SubtipoTareaOut, only=("id", "nombre"))
    actuacion = Nested(ActuacionOut, only=("id", "id_ext", "nombre"))
    expediente = Nested(ExpedienteOut, only=("id", "id_ext", "nro_expte", "caratula"))
